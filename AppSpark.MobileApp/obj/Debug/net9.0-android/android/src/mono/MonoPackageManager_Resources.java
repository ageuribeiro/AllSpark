...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AppSpark.MobileApp.dll" comes first in this list. */
		"AppSpark.MobileApp.dll",
		"GoogleGson.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"AllSpark.Application.dll",
		"AllSpark.Domain.dll",
		"AllSpark.Infra.Data.dll",
		"AllSpark.Infra.IoC.dll",
